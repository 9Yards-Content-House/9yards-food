...
export default function MobileSidebar({ isOpen, onClose }: MobileSidebarProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] lg:hidden">
      ...
      >
        {/* Header */}
        <div className="bg-gradient-to-r from-[#212282] to-[#2d2fa0] px-6 py-5 flex items-center justify-between flex-shrink-0">
          ...
          <button
            ...
            onClick={onClose}
            className="w-8 h-8 flex items-center justify-center rounded-full hover:bg-white/10 transition-colors focus:outline-none focus:ring-2 focus:ring-white/50"
        ...
        <div className="flex-1 overflow-y-auto overscroll-contain scrollbar-thin">
                  ...
                  <Link
                    ...
                    className={`block py-3.5 text-base font-medium transition-colors duration-200 ${
                      isActive
                        ...
                        : 'text-gray-700 hover:text-[#E6411C]'
                    }`}
                  >
                    {link.label}
                  </Link>
          ...
          <div className="px-6 py-6 border-t border-gray-200 mt-auto">
            ...
            <div className="flex items-center gap-4">
              ...
              >
                <svg className="w-[22px] h-[22px]" fill="currentColor" viewBox="0 0 448 512">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-11 h-11 rounded-xl bg-black flex items-center justify-center text-white transition-all duration-300 hover:scale-110 hover:shadow-lg"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-11 h-11 rounded-xl bg-[#25D366] flex items-center justify-center text-white transition-all duration-300 hover:scale-110 hover:shadow-lg"
        ...
        <div className="absolute bottom-0 left-0 right-0 p-5 bg-gradient-to-t from-white via-white to-white/90">
          <Link
            to="/menu?combo=true"
            onClick={onClose}
            className="block w-full py-4 bg-[#E6411C] hover:bg-[#d63815] text-white text-center font-bold text-base rounded-xl transition-all duration-300 active:scale-[0.98]"
          >
            Build Your Combo
          </Link>
        </div>
